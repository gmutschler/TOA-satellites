...
<?php include_partial('hero') ?>
	...
	<div class="textual">
        ...
        <div>
            ...
            <p><a href="/images/content/press/TOA_logo-black-big.png">PNG Version (600x600)</a><br><a href="/images/content/press/TOA_logo-black-vector.eps">EPS Version (Vector graphics)</a></p>
        </div>
        <div>
            <img src="/images/content/press/TOA_logo-white-big.png" class="black" alt="TOA Berlin Logo - Light">
            <h4>TOA Logo - White <em>(Right Click to download)</em></h4>
