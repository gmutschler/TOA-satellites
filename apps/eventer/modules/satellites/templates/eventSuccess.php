...
*/ ?>
		...
		<iframe src="http://www.eventbrite.com/tickets-external?eid=<?=$event->getEventbriteId()?>&ref=etckt&access=<?=$event->getEventbriteAccesscode()?>&access_code=<?=$event->getEventbriteAccesscode()?>&<?=time()?>&v=2" frameborder="0" height="600" width="100%" vspace="0" hspace="0" marginheight="5" marginwidth="5" scrolling="auto" allowtransparency="true"></iframe>
