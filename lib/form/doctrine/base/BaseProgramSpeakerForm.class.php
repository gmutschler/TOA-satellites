...
/**
 * ProgramSpeaker form base class.
 *
 * @method ProgramSpeaker getObject() Returns the current form's model object
 *
 * @package    toaberlin
 * @subpackage form
 ...
 */
abstract class BaseProgramSpeakerForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('program_speaker[%s]');
