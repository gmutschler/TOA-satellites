...
/**
 * ProgramModerator filter form base class.
 *
 * @package    toaberlin
 * @subpackage filter
 ...
 */
abstract class BaseProgramModeratorFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('program_moderator_filters[%s]');
