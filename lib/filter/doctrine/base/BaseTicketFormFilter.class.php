...
abstract class BaseTicketFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sold_paid'            => new sfWidgetFormFilterInput(),
      'sold_free'            => new sfWidgetFormFilterInput(),
      'eventbrite_id'        => new sfWidgetFormFilterInput(),
      'eventbrite_hidden_id' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'sold_paid'            => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'sold_free'            => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'eventbrite_id'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'eventbrite_hidden_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
